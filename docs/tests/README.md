...
| Fichier | Rôle |
| --- | --- |
| [`recette-manuelle.html`](recette-manuelle.html) | Onze scénarios, soixante-et-une étapes, cases à cocher et compte rendu copiable |
...
premier rendu, l'animation de la roue, `prefers-reduced-motion`, l'arbre
...
quatorze contrôles de [`scripts/browser-check/README.md`](../../scripts/browser-check/README.md).
